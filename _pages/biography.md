...
Ethungshan Shitiri is a researcher in wireless and molecular communication systems whose work focuses on intra-body nanoscale communication for in vivo diagnostics and real-time health monitoring. He is with the [Nanonetworking Center in Catalunya at the Universitat Politècnica de Catalunya, Barcelona](https://n3cat.upc.edu/), where he works on human-body and intra-body nanoscale communication research. He is an EU Marie Skłodowska-Curie Actions Postdoctoral Fellow.
